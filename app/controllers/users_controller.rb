class UsersController < ApplicationController
  ...
  # here, tutorial includes :index in the logged_in_user; I will restrict
  # it only to admin users for purpose of the portal
  
  # need to add a before filter called "admin_user"
  # before_action :admin_user,     only: [:destroy, :index]
